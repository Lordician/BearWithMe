...
public class ItemPolarBootsArmor extends ItemArmor {

	public static final String POLAR_BOOTS = "bearwithme:textures/models/armor/polar_bear_boots_legs.png";

	public ItemPolarBootsArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
